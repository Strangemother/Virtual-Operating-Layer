...
set(Qt53DRender_VERSION_STRING 5.6.2)
...
if (NOT TARGET Qt5::3DRender)
    ...
    set(Qt53DRender_PRIVATE_INCLUDE_DIRS
        "${_qt53DRender_install_prefix}/include/qt/Qt3DRender/5.6.2"
        "${_qt53DRender_install_prefix}/include/qt/Qt3DRender/5.6.2/Qt3DRender"
    )
    ...
    foreach(_module_dep ${_Qt53DRender_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.6.2 ${_Qt53DRender_FIND_VERSION_EXACT}
    ...
    if (EXISTS
        "${_qt53DRender_install_prefix}/bin/Qt53DRenderd.dll"
      AND EXISTS
        "${_qt53DRender_install_prefix}/lib/Qt53DRenderd.lib" )
