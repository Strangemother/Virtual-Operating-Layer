...
set(Qt53DQuickRender_VERSION_STRING 5.6.2)
...
if (NOT TARGET Qt5::3DQuickRender)
    ...
    set(Qt53DQuickRender_PRIVATE_INCLUDE_DIRS
        "${_qt53DQuickRender_install_prefix}/include/qt/Qt3DQuickRender/5.6.2"
        "${_qt53DQuickRender_install_prefix}/include/qt/Qt3DQuickRender/5.6.2/Qt3DQuickRender"
    )
    ...
    foreach(_module_dep ${_Qt53DQuickRender_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.6.2 ${_Qt53DQuickRender_FIND_VERSION_EXACT}
    ...
    if (EXISTS
        "${_qt53DQuickRender_install_prefix}/bin/Qt53DQuickRenderd.dll"
      AND EXISTS
        "${_qt53DQuickRender_install_prefix}/lib/Qt53DQuickRenderd.lib" )
