...
set(Qt5Enginio_VERSION_STRING 1.6.2)
...
if (NOT TARGET Qt5::Enginio)
    ...
    set(_Qt5Enginio_OWN_INCLUDE_DIRS "${_qt5Enginio_install_prefix}/include/qt/" "${_qt5Enginio_install_prefix}/include/qt/Enginio")
    set(Qt5Enginio_PRIVATE_INCLUDE_DIRS
        "${_qt5Enginio_install_prefix}/include/qt/Enginio/1.6.2"
        "${_qt5Enginio_install_prefix}/include/qt/Enginio/1.6.2/Enginio"
    )
    ...
    foreach(_module_dep ${_Qt5Enginio_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                1.6.2 ${_Qt5Enginio_FIND_VERSION_EXACT}
    ...
    if (EXISTS
        "${_qt5Enginio_install_prefix}/bin/Qt5Enginiod.dll"
      AND EXISTS
        "${_qt5Enginio_install_prefix}/lib/Qt5Enginiod.lib" )
