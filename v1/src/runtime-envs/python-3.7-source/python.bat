...
@setlocal
@set PYTHONHOME=C:\Users\jay\Documents\projects\desktop\src\runtime-envs\python-3.7-source\

@"C:\Users\jay\Documents\projects\desktop\src\runtime-envs\python-3.7-source\PCbuild\amd64\python.exe" %*
