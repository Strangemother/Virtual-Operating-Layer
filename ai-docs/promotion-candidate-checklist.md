...
```
Blocking Issues:
- Privilege boundary unresolved → cannot define normative description.
...
```
Blocking Issues:
- Validation semantics and precedence rules missing.
Linked Gap Doc: user-tape-validation-extraction.md

### Capability Set
Sources: sections/glossary.md (nodes.md), capability-advertisement-extraction.md, mesh-roles-matrix.md
Evidence:
